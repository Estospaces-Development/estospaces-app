...
import { FastTrackDocuments as IFastTrackDocuments, DocStatus } from '../../mocks/fastTrackCases';
...
const FastTrackDocuments: React.FC<FastTrackDocumentsProps> = ({ documents, onVerify, isReadOnly }) => {
    ...
    return (
        <div className="bg-gray-50 dark:bg-zinc-900/50 rounded-lg p-3 border border-gray-100 dark:border-zinc-800">
