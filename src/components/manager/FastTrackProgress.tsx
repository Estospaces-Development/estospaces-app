        ...
        <div className="w-full relative mt-4 mb-6">
            ...
            <div className="flex justify-between items-center w-full px-2">
                {steps.map((step, index) => {
                  ...
                  ${status === 'current' ? 'bg-primary border-primary text-white scale-110 shadow-lg ring-4 ring-blue-100 dark:ring-blue-900/30' : ''}
                ...
                `}
                  ...
                  ${status === 'current' ? 'text-primary dark:text-blue-400 font-bold' : ''}
