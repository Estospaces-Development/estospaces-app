...
const ClientProfileModal: React.FC<ClientProfileModalProps> = ({ isOpen, onClose, clientName, avatar, clientId = '1' }) => {
    ...
    const handleViewHistory = () => {
        navigate(`/manager/dashboard/client-history/${clientId}`);
    };
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="w-full flex gap-3">
                            <button
                                ...
                                className="flex-1 bg-primary hover:bg-primary-dark text-white py-2.5 rounded-lg font-medium transition-colors"
                            >
                                View History
                            </button>
                            <button
