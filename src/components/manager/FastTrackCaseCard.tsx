...
import { Clock, AlertTriangle, Building, AlertCircle } from 'lucide-react';
    ...
    useEffect(() => {
        const calculateTimeLeft = () => {
            ...
            if (diff <= 0) {
                ...
                setIsExpired(true);
                if (caseData.finalStatus !== 'expired') {
                    // Defer state update to avoid loops, parent should handle if real app
                }
                return;
            }
