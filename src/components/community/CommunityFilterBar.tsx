...
const CommunityFilterBar: React.FC<CommunityFilterBarProps> = ({
    ...
    const tags: Array<{ value: PostTag | 'all'; label: string; color: string }> = [
        { value: 'all', label: 'All Tags', color: 'gray' },
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <select
                        ...
                        className="px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary"
                    >
                        {roles.map((role) => (
