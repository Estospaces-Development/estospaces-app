...
import { CommunityPost, Comment, AuthorRole } from '../../mocks/communityPosts';
                            ...
                            <div key={comment.commentId} className="flex gap-3">
                                ...
                                <div className="flex-1 bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        >
                                            {comment.authorRole.charAt(0).toUpperCase() +
                                                comment.authorRole.slice(1)}
                                        </span>
                                        <span className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <form onSubmit={handleSubmit} className="flex gap-3">
                        ...
                        <div className="flex-1 flex gap-2">
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary"
                            />
                            <button
                                type="submit"
                                disabled={!newComment.trim()}
                                className="px-4 py-2 bg-primary hover:bg-primary/90 text-white rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
