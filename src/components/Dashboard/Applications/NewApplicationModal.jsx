...
const NewApplicationModal = ({ isOpen, onClose, preSelectedProperty = null }) => {
  ...
  const getPropertyImage = (property) => {
    ...
    try {
      ...
      // Filter out empty/null values and get first valid image
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onKeyDown={handleKeyDown}
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors ${
                            formErrors.fullName ? 'border-red-500' : 'border-gray-200 dark:border-gray-600 focus:border-orange-500'
                          }`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onKeyDown={handleKeyDown}
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors ${
                            formErrors.email ? 'border-red-500' : 'border-gray-200 dark:border-gray-600 focus:border-orange-500'
                          }`}
