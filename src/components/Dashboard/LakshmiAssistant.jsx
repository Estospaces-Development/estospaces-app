  ...
  const responses = {
    ...
    navigation: {
      ...
      pages: {
        ...
        'discover': { path: '/dashboard/discover', name: 'Discover Properties' },
        'properties': { path: '/dashboard/discover', name: 'Discover Properties' },
        'messages': { path: '/dashboard/messages', name: 'Messages' },
        'payments': { path: '/dashboard/payments', name: 'Payments' },
        'contracts': { path: '/dashboard/contracts', name: 'Contracts' },
        'profile': { path: '/dashboard/profile', name: 'Profile' },
        'settings': { path: '/dashboard/settings', name: 'Settings' },
        'help': { path: '/dashboard/help', name: 'Help & Support' },
      },
    },
    faq: {
