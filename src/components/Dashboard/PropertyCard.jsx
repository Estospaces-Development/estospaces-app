...
const PropertyCard = ({ property, onViewDetails }) => {
  ...
  // Support multiple image field names: image_urls (from DB), images, or image
  const images = property.image_urls || property.images || [property.image].filter(Boolean);
  const validImages = (Array.isArray(images) ? images : [images]).filter(Boolean).slice(0, 4);
