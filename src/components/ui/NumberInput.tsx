    ...
    <div className="w-full">
      ...
      <div className={`relative flex items-center ${isFocused ? 'ring-2 ring-primary ring-offset-1 rounded-lg' : ''}`}>
        <input
          ...
          disabled={disabled}
          className={`w-full px-4 py-3 pr-12 bg-gray-50 dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-900 dark:text-white transition-all hover:border-gray-300 dark:hover:border-gray-600 ${
            error
        ...
        <div className="absolute right-1 flex flex-col h-full justify-center py-1 gap-px">
          <button
            ...
            className={`p-0.5 rounded-t transition-all flex items-center justify-center ${
          ...
          <button
            ...
            className={`p-0.5 rounded-b transition-all flex items-center justify-center ${
