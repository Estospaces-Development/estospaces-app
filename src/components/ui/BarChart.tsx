...
interface BarChartProps {
  ...
  showCurrency?: boolean; // Whether to show currency symbols (for revenue charts)
}
      ...
      <div className="relative w-full" style={{ height: `${height}px` }}>
        ...
        <div className="ml-12 h-full flex items-end justify-between gap-2 md:gap-4">
          {data.map((item, index) => {
            ...
            const normalizedHeight = Math.max(barHeight, value > 0 ? 5 : 2); // Minimum height for visibility
