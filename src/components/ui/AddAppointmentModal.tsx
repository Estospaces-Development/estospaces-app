          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 bg-white dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:text-white ${errors.clientName ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 bg-white dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:text-white ${errors.date ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 bg-white dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:text-white ${errors.time ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
              />
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className={`w-full px-4 py-2 bg-white dark:bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:text-white ${errors.description ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
