...
const VerificationModal = ({ isOpen, onClose, onVerified, email, phone }: VerificationModalProps) => {
  ...
  const handleSendPhoneCode = () => {
    // Simulate sending verification code to phone
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-center text-2xl tracking-widest"
                    maxLength={6}
                  />
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-primary hover:bg-primary-dark text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
            ...
            {!phoneCodeSent ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors flex items-center justify-center gap-2"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={isVerifying || phoneCode.length !== 6}
                    className="flex-1 px-4 py-2 bg-primary hover:bg-primary-dark text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isVerifying ? 'Verifying...' : 'Verify'}
                    {!isVerifying && <ArrowRight className="w-4 h-4" />}
