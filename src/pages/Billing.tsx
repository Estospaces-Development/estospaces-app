      ...
      <div className="bg-white dark:bg-black rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          ...
          <select
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-700 dark:bg-black dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
          >
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-black">
              <tr>
                <th className="px-6 py-3 text-left caption text-gray-500 dark:text-gray-400 uppercase">Invoice ID</th>
                <th className="px-6 py-3 text-left caption text-gray-500 dark:text-gray-400 uppercase">Property</th>
                <th className="px-6 py-3 text-left caption text-gray-500 dark:text-gray-400 uppercase">Project</th>
                <th className="px-6 py-3 text-left caption text-gray-500 dark:text-gray-400 uppercase">Amount</th>
              ...
              {invoices.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-gray-50 dark:hover:bg-gray-900">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="body-text font-medium text-gray-900 dark:text-white">{invoice.invoiceId}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="body-text text-gray-900 dark:text-white">{invoice.property}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="body-text text-gray-900 dark:text-white">{invoice.project}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="body-text font-medium text-gray-900 dark:text-white">{invoice.amount}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
