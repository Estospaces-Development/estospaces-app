...
import { ArrowLeft, MapPin, Bed, Bath, Square, Download, Share2, Heart } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-[400px]">
                <div className="md:col-span-2 h-full bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden relative group">
                    <img
                        src="https://images.unsplash.com/photo-1600596542815-27b88e31e62e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
                        alt="Main Property"
                ...
                <div className="hidden md:flex flex-col gap-4 h-full">
                    ...
                    <div className="h-1/2 bg-gray-200 dark:bg-gray-800 rounded-xl overflow-hidden">
                        <img
                            src="https://images.unsplash.com/photo-1628187895473-b76e625a2283?y=800&q=80"
                            alt="Interior 2"
                            className="w-full h-full object-cover"
                        />
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-black p-6 rounded-xl border border-gray-200 dark:border-gray-800 sticky top-24">
                        ...
                        <button className="w-full btn-primary mb-3">Schedule Viewing</button>
                        <button className="w-full btn-secondary border border-gray-200 dark:border-gray-700">Download Brochure</button>
                    </div>
                </div>
            </div>
        </div>
