        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12 space-y-8">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  such as security, account access, and remembering your login status. You cannot opt out of these cookies.
                </p>
              </div>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mt-4">
              Please note that blocking some types of cookies may impact your experience on our website and 
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              The length of time a cookie will remain on your device depends on whether it is a "persistent" 
              or "session" cookie. Session cookies last until you close your browser. Persistent cookies remain 
              on your device until they expire or you delete them. Our persistent cookies have varying expiry 
              dates, ranging from 30 days to 2 years.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              or our business practices. We encourage you to review this page periodically for the latest 
